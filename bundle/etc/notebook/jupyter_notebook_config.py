...
if 'JSROOTSYS' in os.environ:
    ...
    c.NotebookApp.extra_static_paths.append(os.path.join("/home/huber/root_install", "js"))
    c.ServerApp.extra_static_paths.append(os.path.join("/home/huber/root_install", "js"))
